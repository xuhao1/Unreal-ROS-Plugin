...
struct  F_visualization_msgs_MarkerArray;
...
struct  F_shape_msgs_SolidPrimitive;
...
struct  F_diagnostic_msgs_KeyValue;

struct  F_diagnostic_msgs_DiagnosticStatus;

struct  F_diagnostic_msgs_DiagnosticArray;
...
struct  F_visualization_msgs_ImageMarker;

struct  F_visualization_msgs_Marker;

struct  F_visualization_msgs_InteractiveMarkerControl;

struct  F_visualization_msgs_InteractiveMarkerPose;
...
struct  F_visualization_msgs_InteractiveMarkerFeedback;
...
struct  F_visualization_msgs_MenuEntry;

struct  F_visualization_msgs_InteractiveMarker;

struct  F_visualization_msgs_InteractiveMarkerUpdate;
...
struct  F_shape_msgs_MeshTriangle;

struct  F_shape_msgs_Mesh;

struct  F_sensor_msgs_Imu;

struct  F_sensor_msgs_MultiDOFJointState;

struct  F_visualization_msgs_InteractiveMarkerInit;
...
struct F_shape_msgs_Plane
{
	...
	std::string TypeName = "shape_msgs/Plane";

};


UCLASS()
class U_shape_msgs_PlaneAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_shape_msgs_PlaneAdvertiser * Create_Plane_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_shape_msgs_Plane Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_shape_msgs_PlaneDelegate, F_shape_msgs_Plane, Data);

UCLASS()
class U_shape_msgs_PlaneSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_shape_msgs_PlaneSubscriber * Create_Plane_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_shape_msgs_PlaneDelegate OnPlaneData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_shape_msgs_Plane Data);
};
...
struct F_visualization_msgs_MarkerArray
{
	...
	std::string TypeName = "visualization_msgs/MarkerArray";

};


UCLASS()
class U_visualization_msgs_MarkerArrayAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_MarkerArrayAdvertiser * Create_MarkerArray_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_MarkerArray Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_MarkerArrayDelegate, F_visualization_msgs_MarkerArray, Data);

UCLASS()
class U_visualization_msgs_MarkerArraySubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_MarkerArraySubscriber * Create_MarkerArray_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_MarkerArrayDelegate OnMarkerArrayData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_MarkerArray Data);
};
...
struct F_dji_sdk_FlightControlInfo
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		int32 cur_ctrl_dev_in_navi_mode;
		
    
		
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		int32 serial_req_status;
...
struct F_shape_msgs_SolidPrimitive
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<float> dimensions;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_BOX = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_SPHERE = 2;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CYLINDER = 3;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CONE = 4;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_BOX_X = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_BOX_Y = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_BOX_Z = 2;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_SPHERE_RADIUS = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CYLINDER_HEIGHT = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CYLINDER_RADIUS = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CONE_HEIGHT = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CONE_RADIUS = 1;
	...
	std::string TypeName = "shape_msgs/SolidPrimitive";

};


UCLASS()
class U_shape_msgs_SolidPrimitiveAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_shape_msgs_SolidPrimitiveAdvertiser * Create_SolidPrimitive_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_shape_msgs_SolidPrimitive Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_shape_msgs_SolidPrimitiveDelegate, F_shape_msgs_SolidPrimitive, Data);

UCLASS()
class U_shape_msgs_SolidPrimitiveSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_shape_msgs_SolidPrimitiveSubscriber * Create_SolidPrimitive_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_shape_msgs_SolidPrimitiveDelegate OnSolidPrimitiveData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_shape_msgs_SolidPrimitive Data);
};
...
struct F_diagnostic_msgs_KeyValue
{
	...
	std::string TypeName = "diagnostic_msgs/KeyValue";

};


UCLASS()
class U_diagnostic_msgs_KeyValueAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_diagnostic_msgs_KeyValueAdvertiser * Create_KeyValue_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_diagnostic_msgs_KeyValue Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_diagnostic_msgs_KeyValueDelegate, F_diagnostic_msgs_KeyValue, Data);

UCLASS()
class U_diagnostic_msgs_KeyValueSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_diagnostic_msgs_KeyValueSubscriber * Create_KeyValue_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_diagnostic_msgs_KeyValueDelegate OnKeyValueData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_diagnostic_msgs_KeyValue Data);
};
...
struct F_diagnostic_msgs_DiagnosticStatus
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_diagnostic_msgs_KeyValue> values;
		...
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_WARN = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_ERROR = 2;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_STALE = 3;
	...
	std::string TypeName = "diagnostic_msgs/DiagnosticStatus";

};


UCLASS()
class U_diagnostic_msgs_DiagnosticStatusAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_diagnostic_msgs_DiagnosticStatusAdvertiser * Create_DiagnosticStatus_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_diagnostic_msgs_DiagnosticStatus Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_diagnostic_msgs_DiagnosticStatusDelegate, F_diagnostic_msgs_DiagnosticStatus, Data);

UCLASS()
class U_diagnostic_msgs_DiagnosticStatusSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_diagnostic_msgs_DiagnosticStatusSubscriber * Create_DiagnosticStatus_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_diagnostic_msgs_DiagnosticStatusDelegate OnDiagnosticStatusData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_diagnostic_msgs_DiagnosticStatus Data);
};
...
struct F_diagnostic_msgs_DiagnosticArray
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_diagnostic_msgs_DiagnosticStatus> status;
	...
	std::string TypeName = "diagnostic_msgs/DiagnosticArray";

};


UCLASS()
class U_diagnostic_msgs_DiagnosticArrayAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_diagnostic_msgs_DiagnosticArrayAdvertiser * Create_DiagnosticArray_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_diagnostic_msgs_DiagnosticArray Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_diagnostic_msgs_DiagnosticArrayDelegate, F_diagnostic_msgs_DiagnosticArray, Data);

UCLASS()
class U_diagnostic_msgs_DiagnosticArraySubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_diagnostic_msgs_DiagnosticArraySubscriber * Create_DiagnosticArray_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_diagnostic_msgs_DiagnosticArrayDelegate OnDiagnosticArrayData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_diagnostic_msgs_DiagnosticArray Data);
};
...
struct F_visualization_msgs_ImageMarker
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		F_std_msgs_ColorRGBA outline_color;
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		F_std_msgs_ColorRGBA fill_color;
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_geometry_msgs_Point> points;
		
    
		
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_std_msgs_ColorRGBA> outline_colors;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CIRCLE = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_LINE_STRIP = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_LINE_LIST = 2;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_POLYGON = 3;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_POINTS = 4;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_ADD = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_REMOVE = 1;
	...
	std::string TypeName = "visualization_msgs/ImageMarker";

};


UCLASS()
class U_visualization_msgs_ImageMarkerAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_ImageMarkerAdvertiser * Create_ImageMarker_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_ImageMarker Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_ImageMarkerDelegate, F_visualization_msgs_ImageMarker, Data);

UCLASS()
class U_visualization_msgs_ImageMarkerSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_ImageMarkerSubscriber * Create_ImageMarker_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_ImageMarkerDelegate OnImageMarkerData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_ImageMarker Data);
};
...
struct F_visualization_msgs_Marker
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		F_geometry_msgs_Vector3 scale;
		
    
		
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		F_std_msgs_ColorRGBA color;
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_std_msgs_ColorRGBA> colors;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_ARROW = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CUBE = 1;
		...
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_LINE_STRIP = 4;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_LINE_LIST = 5;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_CUBE_LIST = 6;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_SPHERE_LIST = 7;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_POINTS = 8;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_TEXT_VIEW_FACING = 9;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MESH_RESOURCE = 10;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_TRIANGLE_LIST = 11;
		...
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MODIFY = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_DELETE = 2;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_DELETEALL = 3;
	...
	std::string TypeName = "visualization_msgs/Marker";

};


UCLASS()
class U_visualization_msgs_MarkerAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_MarkerAdvertiser * Create_Marker_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_Marker Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_MarkerDelegate, F_visualization_msgs_Marker, Data);

UCLASS()
class U_visualization_msgs_MarkerSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_MarkerSubscriber * Create_Marker_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_MarkerDelegate OnMarkerData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_Marker Data);
};
...
struct F_visualization_msgs_InteractiveMarkerControl
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_visualization_msgs_Marker> markers;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_FIXED = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_VIEW_FACING = 2;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MENU = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_BUTTON = 2;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MOVE_PLANE = 4;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_ROTATE_AXIS = 5;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MOVE_ROTATE = 6;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MOVE_3D = 7;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_ROTATE_3D = 8;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MOVE_ROTATE_3D = 9;
	...
	std::string TypeName = "visualization_msgs/InteractiveMarkerControl";

};


UCLASS()
class U_visualization_msgs_InteractiveMarkerControlAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerControlAdvertiser * Create_InteractiveMarkerControl_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_InteractiveMarkerControl Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_InteractiveMarkerControlDelegate, F_visualization_msgs_InteractiveMarkerControl, Data);

UCLASS()
class U_visualization_msgs_InteractiveMarkerControlSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerControlSubscriber * Create_InteractiveMarkerControl_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_InteractiveMarkerControlDelegate OnInteractiveMarkerControlData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_InteractiveMarkerControl Data);
};
...
struct F_visualization_msgs_InteractiveMarkerPose
{
	...
	std::string TypeName = "visualization_msgs/InteractiveMarkerPose";

};


UCLASS()
class U_visualization_msgs_InteractiveMarkerPoseAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerPoseAdvertiser * Create_InteractiveMarkerPose_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_InteractiveMarkerPose Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_InteractiveMarkerPoseDelegate, F_visualization_msgs_InteractiveMarkerPose, Data);

UCLASS()
class U_visualization_msgs_InteractiveMarkerPoseSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerPoseSubscriber * Create_InteractiveMarkerPose_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_InteractiveMarkerPoseDelegate OnInteractiveMarkerPoseData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_InteractiveMarkerPose Data);
};
...
struct F_visualization_msgs_InteractiveMarkerFeedback
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		F_geometry_msgs_Point mouse_point;
		...
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_KEEP_ALIVE = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_POSE_UPDATE = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MENU_SELECT = 2;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_BUTTON_CLICK = 3;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MOUSE_DOWN = 4;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_MOUSE_UP = 5;
	...
	std::string TypeName = "visualization_msgs/InteractiveMarkerFeedback";

};


UCLASS()
class U_visualization_msgs_InteractiveMarkerFeedbackAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerFeedbackAdvertiser * Create_InteractiveMarkerFeedback_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_InteractiveMarkerFeedback Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_InteractiveMarkerFeedbackDelegate, F_visualization_msgs_InteractiveMarkerFeedback, Data);

UCLASS()
class U_visualization_msgs_InteractiveMarkerFeedbackSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerFeedbackSubscriber * Create_InteractiveMarkerFeedback_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_InteractiveMarkerFeedbackDelegate OnInteractiveMarkerFeedbackData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_InteractiveMarkerFeedback Data);
};
...
struct F_visualization_msgs_MenuEntry
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_FEEDBACK = 0;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_ROSRUN = 1;
		
    
		
		UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Robot OS")
		uint8 CONSTANT_ROSLAUNCH = 2;
	...
	std::string TypeName = "visualization_msgs/MenuEntry";

};


UCLASS()
class U_visualization_msgs_MenuEntryAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_MenuEntryAdvertiser * Create_MenuEntry_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_MenuEntry Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_MenuEntryDelegate, F_visualization_msgs_MenuEntry, Data);

UCLASS()
class U_visualization_msgs_MenuEntrySubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_MenuEntrySubscriber * Create_MenuEntry_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_MenuEntryDelegate OnMenuEntryData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_MenuEntry Data);
};
...
struct F_visualization_msgs_InteractiveMarker
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_visualization_msgs_MenuEntry> menu_entries;
	...
	std::string TypeName = "visualization_msgs/InteractiveMarker";

};


UCLASS()
class U_visualization_msgs_InteractiveMarkerAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerAdvertiser * Create_InteractiveMarker_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_InteractiveMarker Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_InteractiveMarkerDelegate, F_visualization_msgs_InteractiveMarker, Data);

UCLASS()
class U_visualization_msgs_InteractiveMarkerSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerSubscriber * Create_InteractiveMarker_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_InteractiveMarkerDelegate OnInteractiveMarkerData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_InteractiveMarker Data);
};
...
struct F_visualization_msgs_InteractiveMarkerUpdate
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_visualization_msgs_InteractiveMarker> markers;
		
    
		
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_visualization_msgs_InteractiveMarkerPose> poses;
	...
	std::string TypeName = "visualization_msgs/InteractiveMarkerUpdate";

};


UCLASS()
class U_visualization_msgs_InteractiveMarkerUpdateAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerUpdateAdvertiser * Create_InteractiveMarkerUpdate_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_InteractiveMarkerUpdate Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_InteractiveMarkerUpdateDelegate, F_visualization_msgs_InteractiveMarkerUpdate, Data);

UCLASS()
class U_visualization_msgs_InteractiveMarkerUpdateSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerUpdateSubscriber * Create_InteractiveMarkerUpdate_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_InteractiveMarkerUpdateDelegate OnInteractiveMarkerUpdateData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_InteractiveMarkerUpdate Data);
};
...
struct F_shape_msgs_MeshTriangle
{
	...
	std::string TypeName = "shape_msgs/MeshTriangle";

};


UCLASS()
class U_shape_msgs_MeshTriangleAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_shape_msgs_MeshTriangleAdvertiser * Create_MeshTriangle_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_shape_msgs_MeshTriangle Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_shape_msgs_MeshTriangleDelegate, F_shape_msgs_MeshTriangle, Data);

UCLASS()
class U_shape_msgs_MeshTriangleSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_shape_msgs_MeshTriangleSubscriber * Create_MeshTriangle_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_shape_msgs_MeshTriangleDelegate OnMeshTriangleData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_shape_msgs_MeshTriangle Data);
};
...
struct F_shape_msgs_Mesh
{
	...
	GENERATED_USTRUCT_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Robot OS")
		TArray<F_shape_msgs_MeshTriangle> triangles;
	...
	std::string TypeName = "shape_msgs/Mesh";

};


UCLASS()
class U_shape_msgs_MeshAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_shape_msgs_MeshAdvertiser * Create_Mesh_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_shape_msgs_Mesh Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_shape_msgs_MeshDelegate, F_shape_msgs_Mesh, Data);

UCLASS()
class U_shape_msgs_MeshSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_shape_msgs_MeshSubscriber * Create_Mesh_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_shape_msgs_MeshDelegate OnMeshData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_shape_msgs_Mesh Data);
};
...
struct F_visualization_msgs_InteractiveMarkerInit
{
	...
	std::string TypeName = "visualization_msgs/InteractiveMarkerInit";

};


UCLASS()
class U_visualization_msgs_InteractiveMarkerInitAdvertiser : public UAdvertiser
{
...
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerInitAdvertiser * Create_InteractiveMarkerInit_Advertiser(FString TopicName);

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	void Publish(F_visualization_msgs_InteractiveMarkerInit Data);
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(F_visualization_msgs_InteractiveMarkerInitDelegate, F_visualization_msgs_InteractiveMarkerInit, Data);

UCLASS()
class U_visualization_msgs_InteractiveMarkerInitSubscriber : public USubscriber
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	static U_visualization_msgs_InteractiveMarkerInitSubscriber * Create_InteractiveMarkerInit_Subscriber(FString _TopicName);

	virtual void ProccessMsg(rapidjson::Value & obj);

	UPROPERTY(BlueprintAssignable, Category = "Robot OS")
	F_visualization_msgs_InteractiveMarkerInitDelegate OnInteractiveMarkerInitData;

	UFUNCTION(BlueprintCallable, Category = "Robot OS")
	virtual void OnRecieve(F_visualization_msgs_InteractiveMarkerInit Data);
};
